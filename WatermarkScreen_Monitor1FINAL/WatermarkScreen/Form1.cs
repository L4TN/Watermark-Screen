        ...
        private void Watermark_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < hei2; i++)
            {
                if ((i % 2) == 0)
                {
                    ...
                    {
                        e.Graphics.DrawString(Text_View+ Timer(), this.Font, ToolDraw, (float)(wid1 + szF1.Width * j), (float)(hei1 + szF1.Height * i));
                        {
                ...
                else
                {
                    ...
                    {
                        e.Graphics.DrawString(Text_View+ Timer(), this.Font, ToolDraw, (float)(wid1 + szF1.Width * (j + 1)), (float)(hei1 + szF1.Height * i));
