...
namespace WatermarkScreen
{
    public partial class Watermark : Form
    {
        ...
        private void Watermark_Paint(object sender, PaintEventArgs e)
        {
            ...
            Text_View = "HS PREVENT \r\n" + "Direitos reservados \r\n" + Environment.UserName + "\r\n";
            Time_Date = DateTime.Now.ToString("dd/MM/yyyy HH:mm");

            var Text_Content = Text_View + Time_Date;
            SizeF szF1 = e.Graphics.MeasureString(Text_View + Time_Date, this.Font);
            ...
            //object used to draw lines, we could use too classes Pen, Brush.
            ...
            for (int i = 0; i < hei2; i++)
            {
                if ((i % 2) == 0)
                {
                    ...
                    {
                        e.Graphics.DrawString(Text_View+ Time_Date, this.Font, ToolDraw, (float)(wid1 + szF1.Width * j), (float)(hei1 + szF1.Height * i));
                    }
                }
                else
                {
                    ...
                    {
                        e.Graphics.DrawString(Text_View+ Time_Date, this.Font, ToolDraw, (float)(wid1 + szF1.Width * (j + 1)), (float)(hei1 + szF1.Height * i));
            ...
            e.Graphics.DrawString(Environment.MachineName, this.Font, ToolDraw, this.Width - 250, this.Height - 100);
            this.Update();
            this.Invalidate();
            Thread.Sleep(1000);
        }
